<?php
/**	* UnrealDev Systems - UnrealObfuscator v1.4.2.76
	*
	* PHP version > 5
	*
	...
	* @package    UnrealObfuscator v1.4.x
	* @author     Giovanne Oliveira <jhollsantos@gmail.com>
	* @copyright  2009 - 2014 UnrealDev Team
	* @license    http://www.php.net/license/3_01.txt  PHP License 3.01
	* @version    v1.4.2.76
	* @link       http://unrealdev.com.br/software/obfuscator
	* @since      File available since Release 1.0.0
	* @deprecated File will be deprecated in version 3.0
**/
class ByteScrambler{
