...
$steps = array(
	...
	/*array(
		...
		'fields' => array(
			...
			array(
				'type' => 'info',
				'value' => 'Welcome to the "Unreal Licensing" installation wizard.
	...
	array(
		...
		'fields' => array(
			...
			array(
				...
				'items' => array(
					'php_version' => array('>=5.0', 'PHP Version'), // PHP version must be at least 4.0
			...
			array(
				...
				'items' => array(
					'../system/config.php' => 'read', // make sure "config.php" file is writable
				),
			),
		),
	),
